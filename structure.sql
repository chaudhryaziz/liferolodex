...
--
-- Name: index_friends_on_email; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_friends_on_email ON friends USING btree (email);


--
-- Name: index_friends_on_username; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_friends_on_username ON friends USING btree (username);
...
INSERT INTO schema_migrations (version) VALUES ('20160812164149'), ('20160814213416'), ('20160815121918');
